...
?>
<section id="404" class="section bg-transparent width-narrow padding-huge ">
	<div id="404-inner" class="section-inner page-inner">
		<h1 class="title1"><span class="<?php echo $text_on_image_classes; ?>"><?php _e("Page Not Found :(", "baseline"); ?></span></h1>
		<div class="box big bg-white">
