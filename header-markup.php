...
<?php if ( has_nav_menu('main-nav') ): ?>
	...
	<?php endif; ?>
	<?php if ( has_nav_menu('lang-nav') ):?>
				<a id="site-language-nav-toggle" class="language-nav-toggle js-modal site-header-item" data-modal-source=".site-language-nav" data-modal-classes-outer="slide-out slide-out-right width-narrow bg-<?php echo $langnav_bgcolor; ?>" data-modal-classes-inner="text-large2"><span id="site-language-nav-toggle-icon" class="svg inline-svg">
